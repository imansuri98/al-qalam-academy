  ...
  return (
    <div className="min-h-screen bg-[#F8FAF6] flex flex-col items-center justify-center p-6 text-center space-y-4">
      ...
      <div className="space-y-1">
        <h2 className="text-base font-extrabold text-[#0F172A]">Loading Al-Arabi Admin Studio...</h2>
        <p className="text-xs text-[#64748B] font-mono">Initializing curriculum management console</p>
      </div>
    </div>
  );
}
